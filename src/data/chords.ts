...
const ALTERNATIVE_VOICINGS: Record<string, GuitarFingering[]> = {
  ...
  'C': [{ frets: [-1,3,5,5,5,3],    barreAt:3,  startFret:3 }],
  ...
  'F': [{ frets: [-1,-1,3,2,1,1],   fingers:[0,0,3,2,1,1] }],
  ...
  'C#maj7': [{ frets: [-1,8,-1,10,9,8], startFret:8 }],
  ...
  'D#maj7': [{ frets: [-1,10,-1,12,11,10], startFret:10 }],
