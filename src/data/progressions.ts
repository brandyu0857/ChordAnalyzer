...
export const PROGRESSION_TEMPLATES: ProgressionTemplate[] = [
  ...
  },
  {
    ...
    examples: ['Stairway to Heaven', 'All Along the Watchtower', '童话'],
  },
  {
    name: '爵士转回进行',
  ...
  },
  {
    ...
    examples: ['Don\'t Stop Believin\'', '光辉岁月', '真的爱你'],
  },
  {
    name: '小调流行进行',
    nameEn: 'Minor Pop',
    ...
    examples: ['Numb (bridge)', 'In the End', '星晴'],
  },
  {
    name: '经典摇滚进行',
    nameEn: 'Classic Rock',
    ...
    examples: ['Wild Thing', 'Louie Louie', '光辉岁月'],
  },
  {
    name: '借用降七进行',
  ...
  },
  {
    ...
    examples: ['Greensleeves', 'Summertime', '梦里花'],
  },
  {
    name: '流行 vi-I 开头',
    nameEn: 'vi-I Open',
  ...
  },
  {
    ...
    examples: ['Big Yellow Taxi', '斑马，斑马', '董小姐'],
  },
];
